...
class RealHologramSetup(DDNN):
    def __init__(self, image_input = False,  num_layers = 3, layers_trainable = [0,1,2], amp = True, phase = True, phase_uncertainty = 0.01, use_realistic_plates = False, propagation_distance = [0.08, 0.08, 0.08], offset = False, intensity_output = True, encoding_pixels = 112, trainable_pixel=112, plate_scale_factor=1,
            ...
            super(RealHologramSetup,self).__init__(trainable_pixel, plate_scale_factor, propagation_size, propagation_pixel, padding, frequency, wavespeed, **kwargs)
