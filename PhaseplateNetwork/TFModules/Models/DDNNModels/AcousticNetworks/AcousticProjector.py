...
class AcousticProjector(DDNN):
    def __init__(self,num_plates = 2, phase_input = False,starting_distance = 0.03, distance = 0.03, trainable_pixel = 60, plate_scale_factor = 3, propagation_size = 0.05, propagation_pixel = 180, padding = 0.05, frequency = 1.00e6, wavespeed = 1484, **kwargs):
        super(AcousticProjector,self).__init__(trainable_pixel, plate_scale_factor, propagation_size, propagation_pixel, padding, frequency, wavespeed, **kwargs)
