...
class InversePropagationLayer(tf.keras.layers.Layer):
    '''
    Inverse Propagation Layer Class. Used to propagate multiple wavefields a certain distance via the angular spectrum method.
    '''
    ...
    def __init__(self, z, N, L, padding=50, f0=2.00e6, cM=1484, channels_last=True, use_FT=True, **kwargs):
        ...
        '''
        super(InversePropagationLayer, self).__init__(**kwargs)
