...
class RegressionEncodingPhase(OpticalLayer):
    ...
    def call(self,input, **kwargs):
        ...
        g12 = g11 * tf.math.exp(tf.complex(0.0, 2*np.pi*tf.reshape(tf.math.abs(input), (-1,1,1,1))))
