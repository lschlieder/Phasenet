...
class RegressionEncodingPhaseWithPropagation(OpticalLayer):
    '''
    Bundle class for all jones polarization encodings
    '''
    def __init__(self, z,L, f0, cM, image_size = 112, sigma = 0.5, **kwargs):
        super(RegressionEncodingPhaseWithPropagation,self).__init__(**kwargs)
        ...
        self.propagation = WavePropagation(z, image_size, L, padding = L*2,f0 = f0, cM = cM)
    ...
    def call(self,input, **kwargs):
        ...
        propagated = self.propagation(out)
