...
class DenoisingOpticalNetworkCallback(tf.keras.callbacks.Callback):
    def __init__(self, output_function, test_data, PATH= '.', images_output_steps = 100, loss_output_steps = 100, checkpoints_output_steps = 100, print_propagation_images = True):
        super(DenoisingOpticalNetworkCallback, self).__init__()        
        self.PATH = PATH
        ...
        self.print_propagation_images = print_propagation_images
