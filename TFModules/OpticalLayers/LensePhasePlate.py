...
class LensePhasePlate(PhasePlate):
    def __init__(self ,shape, L, scale = 2, wavelength= 0.0001, focus = 0.01,  **kwargs):
        super(LensePhasePlate,self).__init__(shape, scale, False,False, **kwargs)
