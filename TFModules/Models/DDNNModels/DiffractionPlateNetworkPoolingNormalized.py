...
class DiffractionPlateNetworkPoolingNormalized(DDNN):
    def __init__(self,pooling_factor = 4, num_layers = 10, phase_encoding = False, distance = 0.005, trainable_pixel = 120, plate_scale_factor = 1, propagation_size = 0.001792, input_pixel = 30, padding = 0.00175, frequency = 3.843e14, wavespeed = 3e8, **kwargs):
        super(DiffractionPlateNetworkPoolingNormalized,self).__init__(trainable_pixel, plate_scale_factor, propagation_size, pooling_factor*input_pixel, padding, frequency, wavespeed, **kwargs)
